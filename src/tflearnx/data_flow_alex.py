...
from datax.transform_patch import rotate_combine_normalize
import config
...
class FeedDictFlowAlex(DataFlow):
    ...
    def __init__(self, feed_dict, coord, batch_size=128, num_threads=8,
                 ...
                 index_array=None):
        super(FeedDictFlowAlex, self).__init__(coord, num_threads, max_queue,
                                               shuffle, continuous,
                                               ensure_data_order,
                                               dprep_dict,
                                               daug_dict)
